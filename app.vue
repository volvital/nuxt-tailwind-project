          ...
          >
            ...
            >
              ...
              <div class=" flex justify-center">
                <DialogTitle class="w-full max-w-xl">
                  ...
                  <div  class=" flex items-center">
                    <div class="flex items-center text-center">
                      <button 
                        ...
                        class="h-14 w-14 inline-flex items-center rounded-2xl px-6 py-3 bg-gray-50/[.15] hover:bg-gray-500 focus:z-20 focus:outline-offset-0 mr-5"                  
                      >
                        <span class="sr-only">Previous</span>
...
export default {
  ...
  computed: {
    ...
    currentDisabledPrevious() {
      return this.currentIdImage === this.JSON[0].id
    },
    currentDisabledNext() {
      return this.currentIdImage === this.JSON[this.JSON.length - 1].id
    }
  },
  methods: {
    closeModal() {
    ...
    setImage(id) {
      let image = this.JSON.find(item => item.id === id);
      this.image = image;
    },
    openModal(id) {
      this.isOpen = true;
    ...
    previousImage(id) {
      let index = this.JSON.findIndex(item => item.id === id);
      this.id = this.JSON[index - 1].id;
      this.setImage(this.id);
    },
    nextImage(id) {
      let index = this.JSON.findIndex(item => item.id === id);
